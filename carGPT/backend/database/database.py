...
class Database:
    ...
    def insert_ad(self, ad_data: Dict[str, Any]) -> Optional[int]:
    ...
    def get_ad_by_id(self, ad_id: int) -> Optional[Dict[str, Any]]:
    ...
    def get_ads_by_criteria(self, criteria: Dict[str, Any], limit: int = 100) -> List[Dict[str, Any]]:
    ...
    def search_ads_by_text(self, search_term: str, fields: Optional[List[str]] = None, limit: int = 100) -> List[Dict[str, Any]]:
